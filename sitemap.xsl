  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/modules/contrib/xmlsitemap/xsl/jquery.tablesorter.min.js"></script>
        <script type="text/javascript" src="/modules/contrib/xmlsitemap/xsl/xmlsitemap.xsl.js"></script>
        <link href="/modules/contrib/xmlsitemap/xsl/xmlsitemap.xsl.css" type="text/css" rel="stylesheet"/>
      </head>
      ...
      <body>
        ...
        <div id="footer">
          <p>Generated by the <a href="https://www.drupal.org/project/xmlsitemap">Drupal XML Sitemap module</a>.</p>
        </div>
      </body>
    </html>
  </xsl:template>
